...
real      ,DIMENSION(:,:)     ,POINTER   :: hfx_rf
real      ,DIMENSION(:,:)     ,POINTER   :: hfx_wl
real      ,DIMENSION(:,:)     ,POINTER   :: anthfx1
real      ,DIMENSION(:,:)     ,POINTER   :: anthfx_rf
real      ,DIMENSION(:,:)     ,POINTER   :: qfx_rf
real      ,DIMENSION(:,:)     ,POINTER   :: lh_rf
real      ,DIMENSION(:,:)     ,POINTER   :: tg_rf
real      ,DIMENSION(:,:)     ,POINTER   :: t2_rf
real      ,DIMENSION(:,:)     ,POINTER   :: tg_wl
real      ,DIMENSION(:,:)     ,POINTER   :: t2_wl
real      ,DIMENSION(:,:)     ,POINTER   :: radwl
real      ,DIMENSION(:,:)     ,POINTER   :: radwl_fnl
real      ,DIMENSION(:,:)     ,POINTER   :: radst
real      ,DIMENSION(:,:)     ,POINTER   :: radst_fnl
real      ,DIMENSION(:,:)     ,POINTER   :: gsw_urb
real      ,DIMENSION(:,:)     ,POINTER   :: gsw_wl
real      ,DIMENSION(:,:)     ,POINTER   :: radnet
real      ,DIMENSION(:,:)     ,POINTER   :: radnet_urb
real      ,DIMENSION(:,:)     ,POINTER   :: radnet_rf
real      ,DIMENSION(:,:)     ,POINTER   :: radnet_wl
real      ,DIMENSION(:,:)     ,POINTER   :: lwdn_urb
real      ,DIMENSION(:,:)     ,POINTER   :: lwdn_rf
real      ,DIMENSION(:,:)     ,POINTER   :: lwdn_wl
real      ,DIMENSION(:,:)     ,POINTER   :: lwup_urb
real      ,DIMENSION(:,:)     ,POINTER   :: lwup_rf
real      ,DIMENSION(:,:)     ,POINTER   :: lwup_wl
!real      ,DIMENSION(:,:)     ,POINTER   :: swddir
!real      ,DIMENSION(:,:)     ,POINTER   :: swddif
